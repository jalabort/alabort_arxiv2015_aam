...
\begin{itemize}
	...
	\item To provide valuable insights into existent add-hoc strategies used to derived fast and exact simultaneous algorithms for fitting AAMs by reinterpreting them as direct applications of the \emph{Schur complement} \cite{Boyd2004} and the \emph{Wiberg algorithm} \cite{Okatani2006, Strelow2012}.
\end{itemize}
