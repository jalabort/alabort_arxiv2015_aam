...
% In this section we report the performance of all CGC algorithms derived in Section \ref{sec:fitting} on the specific problem of face alignment in-the-wild. We start by quantifying
