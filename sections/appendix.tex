...
\begin{tabular}{lc}
\hline\noalign{\smallskip}
\emph{Gauss-Newton} algorithms & Computational cost per iteration
\\
\noalign{\smallskip}
\hline
\noalign{\smallskip}
...
\noalign{\smallskip}
\end{tabular}
\caption{Computational cost per iteration of all \emph{Gauss-Newton} algorithms studied in this paper.}
